...
def get_coin_data():
    ...
    headers = {
        ...
        'X-CMC_PRO_API_KEY': 'b88d38d7-9d59-4e92-8a2e-3cd7811e7f30',
    }
...
def send_message(bot_chatID,bot_message):
    bot_token = '1633213072:AAEorrdwZIM1lCw7ruSZ0v5ZVv7HNPmTt90'
...
def main():
    ...
    while True:
        ...
        time.sleep(3600) #sleep for 1hour
